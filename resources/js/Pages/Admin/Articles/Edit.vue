      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-200 dark:border-neutral-800 pb-5">
        <div class="space-y-1">
          ...
          <h1 class="text-2xl font-extrabold tracking-tight text-neutral-900 dark:text-neutral-50 flex items-center gap-2">
            ...
            <span>Edit Technical Article</span>
          </h1>
          <p class="text-xs text-neutral-500 dark:text-neutral-400">
            Update article content, metadata, publishing status, and topic tags.
          </p>
        </div>
        ...
        <div class="flex items-center gap-3 shrink-0">
          <a
            ...
            target="_blank"
            class="h-9 px-3.5 rounded-[6px] border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-xs font-semibold text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors flex items-center gap-1.5 shadow-xs"
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="rounded-[8px] border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-6 space-y-4 shadow-xs">
            ...
            <RichTextEditor
              ...
              placeholder="Write your in-depth technical article here..."
            />
        ...
        <div class="space-y-6">
          ...
          <div class="rounded-[8px] border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-5 space-y-5 shadow-xs">
            ...
            <div class="p-3 rounded-[6px] bg-white dark:bg-neutral-900/80 border border-slate-300 dark:border-neutral-800 text-xs space-y-1 shadow-2xs">
              ...
              <div class="flex items-center justify-between text-neutral-500">
                <span>Created:</span>
                <span class="font-medium text-neutral-700 dark:text-neutral-300">{{ formatDate(article.created_at) }}</span>
              </div>
            </div>
          </div>
...
const form = useForm({
  ...
  read_time: props.article.read_time || 5,
  tags: Array.isArray(props.article.tags) ? [...props.article.tags] : [],

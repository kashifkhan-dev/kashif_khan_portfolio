    ...
    <div class="space-y-8">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-neutral-800 pb-6">
        ...
        <Link
          ...
          class="h-9 px-4 text-xs font-bold rounded-[6px] bg-white hover:bg-neutral-200 text-black transition-all flex items-center gap-2 shadow-sm shrink-0 cursor-pointer"
        >
          <Plus class="h-4 w-4" />
